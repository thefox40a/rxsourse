...
#الصيد العادى 
# صيد عدد نوع قناة  
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.صيد (.*)"))
async def _(event):
    if ispay[0] == "yes":
        user = await event.get_sender()
        uss = user.username   
        RX_USER = f"| @{uss}" if uss else ""
        ...
        if ch == None:
            try:
                ...
                if replly and replly.text.startswith('@'): 
                    ...
                    ch = await RX(functions.channels.CreateChannelRequest(
                    title="⎉ RX Hunting Channal ⎉",
                    about=f"This channel to hunt usernames by - @vip1602 ,  {RX_USER}",
                    ))
            
                    ch = ch.updates[1].channel_id
            
                    photo = await RX.upload_file(file="RX_HUNTER.jpg")

                    try:
                        await RX(functions.channels.EditPhotoRequest(
                            channel=ch,
                            photo=photo
                        ))
                    except Exception:
                    ...
                    invite = await RX(functions.messages.ExportChatInviteRequest(
                        peer=ch
                    ))
                ...
                await RX.send_message(event.chat_id, f"خطأ في انشاء القناة , الخطأ**-  : {str(e)}**")
    ...
    for i in range(int(msg[0])):
        ...
        if "Available" in isav:
            await asyncio.sleep(1)
            try:
                await RX(functions.channels.UpdateUsernameRequest(
...
ـ          **[⎉ RX FloodWait Hunter ⎉](t.me/vip1602)**
ـ●━━━━━━━●
**مدة الباند** 
     **الساعات: {hours}\n**
     **الدقائق: {minutes}\n**
...
ـ●━━━━━━━●
ـ"""
                await RX.send_message(event.chat_id, message)
...
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.صياد (.*)"))
async def _(event):
    if ispay[0] == "yes":
        user = await event.get_sender()
        uss = user.username   
        ...
        if tr > 1:
            ...
            for current_cycle in range(tr):
                    ...
                    while Checking:
                        ...
                        if "error" in isav:
                            await RX.send_message(event.chat_id, f""" **حدث خطأ فى الفحص** \n قم بارسالها الى مطور السورس @vip1602""")
...
**يمكن خاصية تروح تثبت عليه بحساب اخر**  
**باستخدام أوامر التثبيت `.م4` **
ـ          **[⎉ RX FloodWait Hunter ⎉](t.me/XRsource)**
ـ●━━━━━━━●
**مدة الباند** 
     **الساعات: {hours}\n**
     **الدقائق: {minutes}\n**
...
#############################################################################
# التحكم بالصيد
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.ايقاف الصيد"))
async def _(event):
    if "on" in isclaim:
        isclaim.clear()
        isclaim.append("off")
...
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.حالة الصيد"))
async def _(event):
    if ispay[0] == "yes":
        if "on" in isclaim:
...
#############################################################################
    #تثبيت البوتات
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.تثبيت_بوتات (.*)"))
async def _(event):
    if ispay[0] == "yes":
        user = await event.get_sender()
        uss = user.username   
        ...
        if not username.lower().endswith("bot"):
            ...
            while Checking:
                ...
                if "Available" in isav:
                    await asyncio.sleep(1)
                    try:
                        await RX.send_message("@BotFather", "/newbot")
                        await asyncio.sleep(1)
                        async for message in RX.iter_messages("@BotFather", limit=1):
                            if message.message.startswith("Sorry, you can't add more than"):
                                await RX.send_message(event.chat_id, "لا يمكنك إضافة المزيد من البوتات.")
                                isclaim.clear()
                                isclaim.append("off")
                                trys = 0
                                Checking = False
                                ...
                                await RX.send_message("@BotFather", "● RX Bot Hunter ●")
                                await asyncio.sleep(2)
                                await RX.send_message("@BotFather", f"@{username}")
                                await asyncio.sleep(3)
                                async for message in RX.iter_messages("@BotFather", limit=1):
                                    if message.message.startswith("Done! Congratulations on your new bot."):
                                        await RX.send_message("@BotFather", "/setabouttext")
                                        await asyncio.sleep(1)
                                        await RX.send_message("@BotFather", f"@{username}")
                                        await asyncio.sleep(1)
                                        await RX.send_message("@BotFather", f"The user was Hunted by @vip1602")
                                        await asyncio.sleep(1)
                                        await RX.send_message("@BotFather", "/setuserpic")
                                        await asyncio.sleep(1)
                                        await RX.send_message("@BotFather", f"@{username}")
                                        await asyncio.sleep(1)
                                        await RX.send_file("@BotFather", "RX_HUNTER.jpg")
                                        await asyncio.sleep(1)
                                        await RX.send_message("@BotFather", "/setabouttext")
                                        await asyncio.sleep(1)
                                        await RX.send_message("@BotFather", f"@{username}")
                                        await asyncio.sleep(1)
                                        await RX.send_message("@BotFather", f"RX Bot Hunted By - @vip1602 , ")
                                        await asyncio.sleep(1)
                                        await RX.send_message("@BotFather", "/setdescription")
                                        await asyncio.sleep(1)
                                        await RX.send_message("@BotFather", f"@{username}")
                                        await asyncio.sleep(1)
                                        await RX.send_message("@BotFather", f"RX Bot Hunted By - @vip1602 , \n owner :- {RX_USER}")
                                        
                                        await RX.send_message(event.chat_id, f'''\n●━━  RX  ━━━●\n    ┏━ done  ━┓\n     - ↣  By : @vip1602 , \n    ┗━━━━━┛\n    ┏━  User  ━┓\n    - ↣  ( @{username} )\n    ┗━━━━━┛\n    ┏━ Clicks ━┓\n     - ↣ ( {trys} )\n    ┗━━━━━┛\n    ┏━  type  ━┓\n     - ↣ BotFather\n    ┗━━━━━┛\n    ┏━ CH  ━━┓\n    -  ↣ @XRsource\n    ┗━━━━━┛\n●━━━━━━━━●\n        ''')
                                        await RX.send_message("", f'''\n●━━  RX  ━━━●\n    ┏━ done  ━┓\n     - ↣  By : @vip1602 , \n    ┗━━━━━┛\n    ┏━  User  ━┓\n    - ↣  ( @{username} )\n    ┗━━━━━┛\n    ┏━ Clicks ━┓\n     - ↣ ( {trys} )\n    ┗━━━━━┛\n    ┏━  type  ━┓\n     - ↣ BotFather\n    ┗━━━━━┛\n    ┏━ CH  ━━┓\n    -  ↣ @XRsource\n    ┗━━━━━┛\n●━━━━━━━━●\n        ''')
                                        Checking = False
                                        break
...
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.تثبيت_قناة (.*)"))
async def _(event):
    global trys
    trys = 0
    isclaim.clear()
    ...
    return await RX.send_message(event.chat_id, "**- تم الانتهاء من التثبيت على القناة .. بنجـاح ✅**")

#############################################################################################
# التثبيت على حساب المستخدم

@RX.on(events.NewMessage(outgoing=True, pattern=r"\.تثبيت_حساب (.*)"))
async def _(event):
    global trys
    trys = 0
    ...
    while amodels:
        ...
        if "Available" in isac:
            try:
                await RX(functions.account.UpdateUsernameRequest(username=username))
                await event.client.send_message(event.chat_id, f'''\n●━━  RX  ━━━●\n    ┏━ done  ━┓\n     - ↣  By : @vip1602 , \n    ┗━━━━━┛\n    ┏━  User  ━┓\n    - ↣  ( @{username} )\n    ┗━━━━━┛\n    ┏━ Clicks ━┓\n     - ↣ ( {trys} )\n    ┗━━━━━┛\n    ┏━  type  ━┓\n     - ↣ Account\n    ┗━━━━━┛\n    ┏━ CH  ━━┓\n    -  ↣ @XRsource\n    ┗━━━━━┛\n●━━━━━━━━●\n        ''')
                await event.client.send_message("@vip1602", f'''\n●━━  RX  ━━━●\n    ┏━ done  ━┓\n     - ↣  By : @vip1602 , \n    ┗━━━━━┛\n    ┏━  User  ━┓\n    - ↣  ( @{username} )\n    ┗━━━━━┛\n    ┏━ Clicks ━┓\n     - ↣ ( {trys} )\n    ┗━━━━━┛\n    ┏━  type  ━┓\n     - ↣ Account\n    ┗━━━━━┛\n    ┏━ CH  ━━┓\n    -  ↣ @XRsource\n    ┗━━━━━┛\n●━━━━━━━━●\n        ''')
                amodels = False
                break
...
ـ"""
    ...
    isclaim.append("off")
    trys = 0
    return await RX.send_message(event.chat_id, "**- تم الإنتهـاء من تثبيت اليـوزر ع حسـابك .. بنجـاح ✅**")


LOGS.info("💠 RX Hunter is Running 💠")
...
#############################################################################################
    #التحكم بالتثبيت 
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.ايقاف التثبيت"))
async def _(event):
    if "on" in isclaim:
        isclaim.clear()
        isclaim.append("off")
...
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.حالة التثبيت"))
async def _(event):
    if "on" in isclaim:
...
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.اليوزرات المبندة"))
async def _(event):
    if ispay[0] == "yes":
        await RX.send_file(event.chat_id, 'banned.txt')


#3333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333
ftrys = 0 
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.تصفية المبند"))
async def filter_banned_users(event):
    ...
    if ispay[0] == "yes":
        ...
        try:
            if replly and replly.text.startswith('@'): 
                ...
                ch = await RX(functions.channels.CreateChannelRequest(
                title="⎉ RX Hunting Channal ⎉",
                about=f"This channel to Flood usernames by - @vip1602 ,  | {RX_USER}",
                ))
    ...
    try:
        ...
        await RX.send_file(event.chat_id, 'banned.txt')  # بعد الانتهاء
    except Exception as e:
        await RX.send_message(event.chat_id, f"خطأ في التصفية , الخطأ**-  : {str(e)}**")


@RX.on(events.NewMessage(outgoing=True, pattern=r"\.حالة التصفية"))
...
################################################################
    #الانواع التقليدية
# @RX.on(events.NewMessage(outgoing=True, pattern=r"\.الانواع(\d+)?"))
...
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.الانواع"))
async def show_type(event):
    if ispay[0] == "yes":
...
################################################################
    #الانواع التلقائية
# @RX.on(events.NewMessage(outgoing=True, pattern=r"\.النوع(\d+)?"))
# async def show_type(event):
#     if ispay[0] == "yes":
#         if event.pattern_match.group(1) is not None:
#             type_number = int(event.pattern_match.group(1))
...
#         else:
#             await event.edit(Auto_Checker["Types1"])
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.النوع"))
async def show_type(event):
    if ispay[0] == "yes":
        await event.edit(Main_Auto_Checker, link_preview=None)
#===================================================================
@RX.on(events.NewMessage(outgoing=True, pattern=r"\.ج"))
async def _(event):
    if ispay[0] == "yes":
        user = await event.get_sender()
        uss = user.username
        ...
        await RX.send_message(event.chat_id, f"{str(user)}")
        await RX.send_message(event.chat_id, f"{str(uss)}")
        await RX.send_message(event.chat_id, f"{str(uss1)}")
        await RX.send_message(event.chat_id, f"{str(uss2)}")
        await RX.send_message(event.chat_id, f"{str(uss3)}")
        await RX.send_message(event.chat_id, f"{str(uss4)}")
        await event.edit(f"""
[⎉ RX Hunter Source ⎉](t.me/XRsource)
ـ●━━━━━━━━━━━━━━●
...
#
#@RX.on(events.CallbackQuery(data="next"))
...
#
#@RX.on(events.CallbackQuery(data="previous"))
